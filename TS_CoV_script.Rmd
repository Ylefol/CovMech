...
my_path_data<-'data/TS_covid/processed_adjusted_cov_dta.rds'
my_path_sample_dta<-'data/TS_covid/sample_file_viremia_no_healthy_rem_patients.csv'
...
name_control<-'Non.viremia' #Name of experiment as seen in the sample file
name_experiment<-'Viremia' #Name of control as seen in the sample file
