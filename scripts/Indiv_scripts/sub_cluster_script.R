...
my_org_sem_sim='org.Ce.eg.db'

log_tp_traj=F

targeted_cluster='C8'

target_dir='TS_results_BY273_vs_N2_Fran_Nikola'
...
load(file = paste0(target_dir,'/timeSeries_obj_Fran.Rdata'))
...
GO_dotplot_wrapper(sub_analysis_name,target_ontology,target_top,custom_width = 10)
