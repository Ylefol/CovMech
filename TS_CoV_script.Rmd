...
# Rscript -e "rmarkdown::render('TS_analysis.Rmd',output_file='YOURNAMEHERE.html')"
library(knitr)
...
```{r parameter_setup}
# setwd("~/A_Projects/EpiGen/R_Work_Folder/TimeSeriesAnalysis/")#set the repository
source('R/object.R') #Load function to create timeseries object

#Give names to saved object and name of results repository
name_result_folder<-'TS_results/'
obj_name<-'timeseries_obj_res.Rdata'

#Path to count data and sample data respectively
my_path_data<-'data/removed_002_127/TS_covid/processed_adjusted_cov_dta.rds'
my_path_sample_dta<-'data/removed_002_127/TS_covid/sample_file_no_healthy_rem_patients.csv'
...
name_control<-'Moderate' #Name of experiment as seen in the sample file
name_experiment<-'Severe' #Name of control as seen in the sample file
...
#Load functions for rmarkdown illustration
