...
custom_GO_selection<-c('neutrophil degranulation','neutrophil activation','type I interferon signaling pathway',
                       ...
                       'wound healing','coagulation','platelet activation','humoral immune response',
                       'translation','ribosome biogenesis','antigen processing and presentation of peptide antigen via MHC class II',
                       'MHC class II protein complex assembly','T cell receptor signaling pathway','T cell activation')
...
plt<-ggplot(full_data, aes(x=timepoints, y=Description, size=`-log10(padj)`, color=enrichmentScore)) +
  ...
  ylab(NULL) + ggtitle('Viremia vs non-viremia') + theme_dose(15) +
